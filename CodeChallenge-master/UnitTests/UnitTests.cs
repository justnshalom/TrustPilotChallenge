...
namespace UnitTests
{
    ...
    public class UnitTests
    {
        ...
        {
            ulong cost = 0;
            Cost.TryGetCost("trustpilot", out cost);
        ...
        public void GetHashTest()
        {
            ...
            ulong cost2 = 0;
            ulong cost3 = 0;
            bool valid1 = Cost.TryGetCost(Cost.Phrase, out cost1);
            bool valid2 = Cost.TryGetCost("invalid", out cost2);
            bool valid3 = Cost.TryGetCost("trustpilot", out cost3);
        ...
        public void GetValidWordsTest()
        {
            ...
            {
                ulong cost = 0;
                bool valid = Cost.TryGetCost(WordList.ValidWords[i].Letters, out cost);
